(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_e23263._.js", {
...
;
;
function EditableText({ id, initialText, hasChanged, setHasChanged, mitigation = false, count, setCount, onSave, className = "" }) {
    _s();
    ...
    const [dbImage, setDbImage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [hasImage, seHasImage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditableText.useEffect": ()=>{
            const func = {
                "EditableText.useEffect.func": async ()=>{
                    const { data, error } = await client.from("images").select("img").eq("ticker", id).single();
                    if (data) {
                        setDbImage(data.img);
                        seHasImage(true);
                    }
                }
            }["EditableText.useEffect.func"];
            func();
        }
    }["EditableText.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const uploadImage = async (file)=>{
        ...
        const { data, error } = await client.from("images").upsert([
            {
                ticker: id,
                img: encodedImage
            }
    ...
    async function getEncodedImage(imageFile) {
    ...
    const handleCut = async ()=>{
        const { data, error } = await client.from("images").delete().eq("ticker", id).single();
        console.log(data, error);
...
_s(EditableText, "Xv3Zcn/27VnvQM6TdcssKSYB4sM=");
_c = EditableText;
var _c;
...
function StockDataDisplay({ data, id, userId }) {
    ...
    const getOneYrDsc = async (name)=>{
        const des = await dsc(`Give 2024 stock price summary of ${name} in 40 words`);
        setDataSave((prev)=>({
                ...prev,
                oneYrDsc: des
            }));
...
_c5 = GradientIcon;
function FinancialSnapshot({ ticker, cacheData, hasChanged, setHasChanged, setEditedVals, count, setCount }) {
...
//# sourceMappingURL=src_e23263._.js.map