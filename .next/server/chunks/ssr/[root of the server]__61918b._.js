...
function StockDataDisplay({ data, id, userId }) {
    ...
    //         .from("company")
    //         .select(
    //           "revenue24,ebit24,netProfit24,ebitda24,revenue23,ebit23,netProfit23,ebitda23,revenue22,ebit22,netProfit22,ebitda22,revenue21,ebit21,netProfit21,ebitda21,roi24,roi23,roi22,roi21,oneYrDsc"
    //         )
    //         .eq("name", data.name)
    //         .single();
    //       let his;
    //       if (!row?.oneYrDsc) {
    //         his = await dsc(
    //           `Give me the summary of 1-Year Stock Price of ${data.name} in 30 words`
    //         );
    //       }
    ...
    //     }
    //   }
    // }, [client, cachedData, data, id, dsc, history]);
    ...
    //     fetchFinancialHistory();
    //   }
    // }, [cachedData, fetchFinancialHistory, history]);
    if (!cachedData) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: "Loading..."
        }, void 0, false, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__61918b._.js.map